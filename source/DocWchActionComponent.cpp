...
*/
DocWchActionComponent::DocWchActionComponent(IPMUnknown* boss): CActionComponent(boss)
{
}

/* DoAction
*/
void DocWchActionComponent::DoAction(IActiveContext* ac, ActionID actionID, GSysPoint mousePoint, IPMUnknown* widget)
{
	switch (actionID.Get())
	{
...
/* UpdateActionStates
*/
void DocWchActionComponent::UpdateActionStates(IActiveContext* ac,IActionStateList* listToUpdate,GSysPoint mousePoint,IPMUnknown* widget)
{
	do
    {
