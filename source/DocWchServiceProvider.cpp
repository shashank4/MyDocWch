...
*/
DocWchServiceProvider::DocWchServiceProvider(IPMUnknown* boss): CServiceProvider(boss)
{
	...
	//Select TextBox
	fSupportedServiceIDs.push_back(kNewStorySignalResponderService);                  ///////////////////////////////push req service.
