...
// InterfaceIDs:
DECLARE_PMID(kInterfaceIDSpace, IID_IMYOBSERVER, kDocWchPrefix + 0)
DECLARE_PMID(kInterfaceIDSpace, IID_IMYACTIVESELECTIONOBSERVER, kDocWchPrefix + 1)
DECLARE_PMID(kInterfaceIDSpace, IID_IPARASTYLENAMETABLE, kDocWchPrefix + 2)
...
DECLARE_PMID(kImplementationIDSpace, kMyObserverImpl,	kDocWchPrefix + 3)
DECLARE_PMID(kImplementationIDSpace, kMyActiveSelectionObserverImpl,	kDocWchPrefix + 4)
...
#define kNewStoryCreateSignalStringKey      kDocWchStringPrefix "kNewStoryCreateSignalStringKey"
